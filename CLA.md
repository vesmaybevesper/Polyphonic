...
> **Note on acceptance:** Physical signature is not required. Acceptance of this Agreement is made by posting the statement 
> specified in [CONTRIBUTING.md](CONTRIBUTING.md) as a comment in your pull request. That comment, tied to your verified GitHub identity and 
> timestamped, constitutes your signature for the purposes of this Agreement.

Thank you for your interest in contributing to Polyphonic ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To
make this document effective, please include the agreement phrase listed in [CONTRIBUTING.md](CONTRIBUTING.md) in your Pull Request. This is a legally binding
...
## 1. Definitions
   ...
   **"Contribution"** means any work of authorship that is Submitted by You to Us in which You own or
   ...
   you must include the other Copyright Owner(s), License(s), and Source(s) so that we may verify its 
...
###    2.3 Outbound License
   ...
   In addition, We may use the following licenses for Media in the Contribution: MIT (including any right to adopt any future version of a license if permitted).
...
## 3. Agreement
   ...
   (d) You have followed the instructions relating to code You do not own the
   Copyright in the entirety as outlined in [CONTRIBUTING.md](CONTRIBUTING.md).
...
###    6.1 
   This Agreement will be governed by and construed in accordance with the laws of the United States of 
   America excluding its conflicts of law provisions. Under certain circumstances, the
...
_This work is licensed under a Creative Commons Attribution 3.0 Unported License._

_Harmony Individual Contributor License Agreement (HA-CLA-I)_
